...
from .views import (
    ...
    registra_pagamento_form, salva_pagamento, get_scadenza_row
)

urlpatterns = [
    path('', dashboard_view, name='dashboard'),
    path('scadenziario/incassi/', scadenziario_incassi_view, name='scadenziario_incassi'),
    path('scadenziario/pagamenti/', scadenziario_pagamenti_view, name='scadenziario_pagamenti'),
